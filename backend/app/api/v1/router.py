...
from app.api.v1.routes import auth,transactions,categories,budgets,notifications,analytics,recurring_transaction
...
api_router.include_router(recurring_transaction.router)